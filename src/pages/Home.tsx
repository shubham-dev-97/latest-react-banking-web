...
//     TableHead, TableRow, TablePagination, InputAdornment, Button, Alert,useMediaQuery, useTheme
// } from '@mui/material';
// import {
...
//                     label="As On Date"
//                     onChange={(e) => setSelectedDate(e.target.value)}
//                     renderValue={(value) => formatDateToDDMMYYYY(value)}
//                 >
//                     {datesLoading ? (
//                         <MenuItem disabled>Loading dates...</MenuItem>
//                     ) : availableDates?.map((date) => (
...
//                         <StyledCard
//     title={t('home.total_deposit_portfolio')}  
//     value={formatCurrency(portfolioOverview?.total_Deposit)}
//     subtitle={t('home.all_deposit_accounts')}  
//     icon={<Savings />}
//     colorIndex={3}
// />
//                     </Grid>
...
//                         <Typography>{t('home.loading_chart_data', 'Loading chart data...')}</Typography>
//                     </Paper>
...
//                 ) : (
//                     <Paper sx={{ p: 3, mb: 4, textAlign: 'center' }}>
//                         <Typography color="textSecondary">{t('home.no_hc_data', 'No HC distribution data available for this date.')}</Typography>
//                     </Paper>
//                 )}
...
//                     <Paper sx={{ p: 3, mb: 4, textAlign: 'center' }}>
//                         <CircularProgress />
//                         <Typography sx={{ mt: 2 }}>{t('home.loading_audit_data', 'Loading audit data...')}</Typography>
//                     </Paper>
...
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Loan Account No</TableCell>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Borrower Name</TableCell>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Branch</TableCell>
//                                         <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Outstanding</TableCell>
//                                         <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Overdue</TableCell>
//                                         <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Days Past Due</TableCell>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>RBI Asset Class</TableCell>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Security Type</TableCell>
//                                         <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Provision</TableCell>
//                                     </TableRow>
//                                 </TableHead>
//                                 <TableBody>
...
//                                                 <Typography color="textSecondary">{t('common.no_records_found', 'No records found')}</Typography>
//                                             </TableCell>
//                                         </TableRow>
//                                     ) : (
...
//                 ) : (
//                     <Paper sx={{ p: 3, mb: 4, textAlign: 'center' }}>
//                         <Typography color="textSecondary">{t('home.no_rbi_loan_data', 'No RBI Loan Audit data available for this date.')}</Typography>
//                     </Paper>
//                 )}
...
//                     <Paper sx={{ p: 3, mb: 4, textAlign: 'center' }}>
//                         <CircularProgress />
//                         <Typography sx={{ mt: 2 }}>{t('home.loading_deposit_audit_data', 'Loading deposit audit data...')}</Typography>
//                     </Paper>
...
//                                 <TableHead>
//                                     <TableRow sx={{ bgcolor: 'primary.main' }}>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Account No</TableCell>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Customer Name</TableCell>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Branch</TableCell>
//                                         <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Current Balance</TableCell>
//                                         <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Deposit Amount</TableCell>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Maturity Date</TableCell>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>KYC Status</TableCell>
//                                         <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>Account Status</TableCell>
//                                     </TableRow>
//                                 </TableHead>
//                                   <TableBody>
...
//                 ) : (
//                     <Paper sx={{ p: 3, mb: 4, textAlign: 'center' }}>
//                         <Typography color="textSecondary">{t('home.no_rbi_deposit_data', 'No RBI Deposit Audit data available for this date.')}</Typography>
//                     </Paper>
//                 )}
//             </Container>
//         </Box>
...
import { useDashboardData, useRbiDepositAuditDumpPaginated, useRbiLoanAuditDump } from '../hooks/useDashboardData';
import { useHomeCustomerSummary, useAvailableDates } from '../hooks/useCustomerData';
import { formatCurrency, formatNumber, formatPercentage, formatDateToDDMMYYYY } from '../utils/formatters';
import MonthlyTrendChart from '../components/dashboard/MonthlyTrendChart';
import { useDepositOpeningSummary } from '../hooks/useDepositData';
...
const Home: React.FC = () => {
    const { 
        ...
        interestAndOverdueKPI, interestKpiLoading,
        almBucketRBI, almLoading,
        depLoanMonthlyTrend, depLoanTrendLoading
    } = useDashboardData();

    // Data aliases for components
    const almData = almBucketRBI;
    const depLoanTrend = depLoanMonthlyTrend;
    const kpiData = interestAndOverdueKPI;
    const portfolioData = portfolioOverview;
    const isPortfolioLoading = portfolioLoading;
    const isKpiLoading = interestKpiLoading;
    ...
    // We'll declare pagination states first to use in the hook
    const [searchTerm, setSearchTerm] = useState('');
    const [rbiClassFilter, setRbiClassFilter] = useState('');
    const [securityTypeFilter, setSecurityTypeFilter] = useState('');
    const [page, setPage] = useState(0);
    ...
    const { data: rbiAuditDataRaw, isLoading: rbiAuditLoading } = useRbiLoanAuditDump(
        selectedDate !== 'all' ? selectedDate : ''
    );
    
    const rbiAuditData = rbiAuditDataRaw || [];

    // For Deposit Audit - Paginated version
    const [depositSearchTerm, setDepositSearchTerm] = useState('');
    const [depositPage, setDepositPage] = useState(0); // 0-indexed for TablePagination
    const [depositRowsPerPage, setDepositRowsPerPage] = useState(50);

    const { data: depositPaginatedData, isLoading: rbiDepositLoading, refetch: refetchDeposit } = useRbiDepositAuditDumpPaginated(
        selectedDate !== 'all' ? selectedDate : '',
        depositPage + 1, // backend is 1-indexed
        depositRowsPerPage
    );
    ...
    const filteredDepositData = useMemo(() => {
        if (!rbiDepositData) return [];
        return rbiDepositData.filter(item => {
            if (depositSearchTerm) {
                const searchLower = depositSearchTerm.toLowerCase();
                return (
                    item.accounT_NO?.toString().includes(depositSearchTerm) ||
                    item.customeR_NAME?.toLowerCase().includes(searchLower) ||
                    item.brancH_ID?.toString().toLowerCase().includes(searchLower)
                );
            }
            return true;
        });
    }, [rbiDepositData, depositSearchTerm]);

    const paginatedDepositData = filteredDepositData;
    ...
    const activeLoanAccounts = homeKpi?.activeLoanAccounts || 0;
    const activeDepositAccounts = homeKpi?.activeDepositAccounts || 0;
    // Audit Loan Dump states are already declared above

    // Filter and paginate audit data (frontend filtering works on the current page data now)
    const filteredAuditData = useMemo(() => {
        if (!rbiAuditData) return [];
        ...
        return rbiAuditData.filter(item => {
            const matchesSearch = searchTerm ? 
                (item.loaN_ACCOUNT_NO?.toString().includes(searchTerm) || 
                 ...
                 item.paN_NO?.toLowerCase().includes(searchTerm.toLowerCase())) : true;
            
            const matchesClass = rbiClassFilter ? item.rbI_ASSET_CLASS === rbiClassFilter : true;
            const matchesSecurity = securityTypeFilter ? item.securitY_TYPE === securityTypeFilter : true;

            return matchesSearch && matchesClass && matchesSecurity;
        });
    }, [rbiAuditData, searchTerm, rbiClassFilter, securityTypeFilter]);
    ...
    const totalLoanAuditCount = filteredAuditData.length;

    // Export function for Loan Audit
    const handleExportAuditCSV = () => {
        if (!filteredAuditData.length) return;

        const headers = [t('common.loan_account_no'), t('common.borrower_name'), t('common.branch'), t('common.outstanding'), t('common.overdue'), t('common.days_past_due'), t('common.rbi_asset_class'), t('common.security_type'), t('common.provision')];
        const csvData = filteredAuditData.map(item => [
            item.loaN_ACCOUNT_NO,
            item.borroweR_NAME,
            item.brancH_ID,
    ...
    //For Deposit Audit
    const handleExportDepositCSV = () => {
        if (!filteredDepositData.length) return;

        const headers = [t('common.account_no'), t('common.customer_name'), t('common.branch'), t('common.current_balance'), t('common.deposit_amount'), t('common.maturity_date'), t('common.kyc_status'), t('common.account_status')];
        const csvData = filteredDepositData.map(item => [
            item.accounT_NO,
            item.customeR_NAME,
            item.brancH_ID,
            item.currenT_BALANCE,
    ...
    const isLoading = datesLoading || homeKpiLoading || summaryLoading || 
        depositLoading || loanLoading || trendLoading || customerSummaryLoading || 
        depositOpeningLoading || npaLoading || hcLoading || 
        portfolioLoading || interestKpiLoading || almLoading || depLoanTrendLoading || rbiAuditLoading || rbiDepositLoading;
        ...
        <Box sx={{ width: '100%', height: '100%', overflow: 'auto' }}>
            <Container maxWidth={false} sx={{ py: 2, px: { xs: 1, md: 2 } }}>
                ...
                <Grid container spacing={2} sx={{ mb: 3 }}>
                    ...
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.total_loan_portfolio')}
                            value={formatCurrency(portfolioOverview?.total_Loan)}
                            subtitle={t('home.all_loan_accounts')}
                            icon={<AccountBalance />}
                            colorIndex={0}
                        />
                    </Grid>
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.net_position')}
                            value={formatCurrency(portfolioOverview?.net_Position)}
                            subtitle={t('home.deposits_minus_loans')}
                            icon={<AccountBalanceWallet />}
                            colorIndex={2}
                        />
                    </Grid>
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.loan_to_deposit_ratio')}
                            value={`${(portfolioOverview?.loan_To_Deposit_Ratio || 0).toFixed(1)}%`}
                            subtitle={portfolioOverview?.loan_To_Deposit_Ratio > 100 ? t('home.high_risk') : portfolioOverview?.loan_To_Deposit_Ratio > 80 ? t('home.moderate') : t('home.healthy')}
                            icon={<Assessment />}
                            colorIndex={4}
                        />
                    </Grid>
                ...
                {/* Performance Indicators Section */}
                <Typography variant="h6" sx={{ mb: 2, fontWeight: 600, color: 'primary.main' }}>
                    {t('home.performance_indicators')}
                </Typography>
                <Grid container spacing={2} sx={{ mb: 3 }}>
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.avg_loan_interest_rate')}
                            value={formatPercentage(kpiData?.avg_Loan_Interest_Rate)}
                            subtitle={t('home.portfolio_average')}
                            icon={<TrendingUp />}
                            colorIndex={4}
                        />
                    </Grid>
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.avg_deposit_interest_rate')}
                            value={formatPercentage(kpiData?.avg_Deposit_Interest_Rate)}
                            subtitle={t('home.portfolio_average')}
                            icon={<TrendingDown />}
                            colorIndex={3}
                    ...
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.overdue_amount')}
                            value={formatCurrency(kpiData?.overdue_Amount)}
                            subtitle={t('home.total_overdue_amount')}
                            icon={<Warning />}
                            colorIndex={1}
                        />
                    </Grid>
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.average_account_size')}
                            value={formatCurrency(kpiData?.avg_Account_Size)}
                            subtitle={t('home.per_account_average')}
                            icon={<AttachMoney />}
                            colorIndex={5}
                        />
                    </Grid>
                ...
                {/* Customer Summary with Styled Cards */}
                <Typography variant="h6" sx={{ mt: 4, mb: 2, fontWeight: 600, color: 'primary.main' }}>
                    {t('home.customer_summary')} ({t('home.as_of')} {selectedDate})
                </Typography>
                <Grid container spacing={2} sx={{ mb: 4 }}>
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.total_deposit_customers')}
                            value={(customerSummary?.totalDepositCustomers)}
                            icon={<People />}
                            colorIndex={2}
                        />
                    ...
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.total_loan_customers')}
                            value={(customerSummary?.totalLoanCustomers)}
                            icon={<People />}
                            colorIndex={4}
                        />
                    ...
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.total_customers')}
                            value={(customerSummary?.totalCustomers)}
                            subtitle={t('home.deposit_loan')}
                            icon={<PeopleAlt />}
                            colorIndex={0}
                        />
                    </Grid>
                    <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                        <StyledCard
                            title={t('home.npa_customers')}
                            value={(customerSummary?.npaCustomers)}
                            subtitle={t('home.non_performing_assets')}
                            icon={<Warning />}
                            colorIndex={1}
                        />
                    </Grid>
                ...
                {/* Deposit Opening Summary */}
                <Typography variant="h6" sx={{ mt: 4, mb: 2, fontWeight: 600, color: 'primary.main' }}>
                    {t('home.deposit_growth_summary')} {selectedDate !== 'all' ? `(${t('home.as_of')} ${selectedDate})` : ''}
                </Typography>
                ...
                {selectedDate === 'all' ? (
                    ...
                    <Grid container spacing={2} sx={{ mb: 4 }}>
                        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                            <StyledCard
                                title={t('home.new_accounts_last_30_days')}
                                value={(depositOpening?.totalDepositOpenLast30Days)}
                                icon={<CalendarToday />}
                                colorIndex={2}
                            />
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                            <StyledCard
                                title={t('home.total_active_accounts')}
                                value={(depositOpening?.totalDepositAccountInBank)}
                                icon={<AccountBalance />}
                                colorIndex={3}
                            />
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                            <StyledCard
                                title={t('home.total_deposit_amount')}
                                value={formatCurrency(depositOpening?.totalDepositAmount)}
                                icon={<AttachMoney />}
                                colorIndex={0}
                            />
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                            <StyledCard
                                title={t('home.opening_percentage')}
                                value={`${(depositOpening?.openingPercentage || 0).toFixed(2)}%`}
                                subtitle={t('home.new_accounts_vs_total')}
                                icon={<Percent />}
                                colorIndex={5}
                            />
                        </Grid>
                ...
                {/* NPA Summary */}
                <Typography variant="h6" sx={{ mt: 4, mb: 2, fontWeight: 600, color: 'primary.main' }}>
                    {t('home.npa_summary')} {selectedDate !== 'all' ? `(${t('home.as_of')} ${selectedDate})` : ''}
                </Typography>
                ...
                {selectedDate === 'all' ? (
                    ...
                    <Grid container spacing={2} sx={{ mb: 4 }}>
                        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                            <StyledCard
                                title={t('home.new_npa_last_30_days')}
                                value={(npaSummary?.totalNPAOpenLast30Days)}
                                icon={<WarningAmberIcon />}
                                colorIndex={1}
                            />
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                            <StyledCard
                                title={t('home.total_npa_accounts')}
                                value={(npaSummary?.totalNPAAccountInBank)}
                                icon={<Warning />}
                                colorIndex={1}
                            />
                        ...
                        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                            <StyledCard
                                title={t('home.npa_opening_percentage')}
                                value={`${(npaSummary?.openingPercentage || 0).toFixed(2)}%`}
                                subtitle={t('home.new_npa_vs_total')}
                                icon={<Percent />}
                                colorIndex={1}
                            />
                        </Grid>
                ...
                {/* HC Distribution Chart */}
                <Typography variant="h6" sx={{ mt: 4, mb: 2, fontWeight: 600, color: 'primary.main' }}>
                    {t('home.housing_category_distribution')} {selectedDate !== 'all' ? `(${t('home.as_of')} ${selectedDate})` : ''}
                </Typography>
                ...
                {selectedDate === 'all' ? (
                    ...
                    <Paper sx={{ p: 3, mb: 4, textAlign: 'center' }}>
                        <Typography>{t('common.loading_chart')}</Typography>
                    </Paper>
                ) : hcData && hcData.length > 0 ? (
                    <Paper sx={{ p: 3, mb: 4 }}>
                        <Box sx={{ width: '100%', height: 400 }}>
                            <ResponsiveContainer>
                                ...
                                >
                                    ...
                                    <YAxis />
                                    <Tooltip
                                        formatter={(value: number) => [`${value} ${t('home.accounts', 'Accounts')}`, t('home.count', 'Count')]}
                                        labelFormatter={(label) => `${t('home.hc_code', 'HC Code')}: ${label}`}
                                    />
                                    <Legend />
                                    <Bar dataKey="count" name={t('home.number_of_accounts', 'Number of Accounts')}>
                                        {hcData.map((entry, index) => (
                                            <Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length]} />
                                        ))}
                                    </Bar>
                        ...
                        <TableContainer component={Paper} sx={{ mt: 3 }}>
                            <Table size="small">
                                <TableHead>
                                    <TableRow sx={{ bgcolor: '#f5f5f5' }}>
                                        <TableCell><strong>{t('home.code')}</strong></TableCell>
                                        <TableCell align="right"><strong>{t('home.number_of_accounts')}</strong></TableCell>
                                        <TableCell align="right"><strong>{t('home.percentage')}</strong></TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {hcData.map((item, index) => {
                                        ...
                                        return (
                                            <TableRow key={index}>
                                                <TableCell>{item.hc || t('common.unknown')}</TableCell>
                                                <TableCell align="right">{formatNumber(item.count)}</TableCell>
                                                <TableCell align="right">{percentage}%</TableCell>
                                            </TableRow>
                                        );
                                    ...
                                    <TableRow sx={{ bgcolor: '#f5f5f5' }}>
                                        <TableCell><strong>{t('home.total')}</strong></TableCell>
                                        <TableCell align="right"><strong>
                                            {formatNumber(hcData.reduce((sum, i) => sum + i.count, 0))}
                                        </strong></TableCell>
                                        <TableCell align="right"><strong>100%</strong></TableCell>
                ...
                {/* ALM Bucket Analysis */}
                <Typography variant="h6" sx={{ mt: 4, mb: 2, fontWeight: 600, color: 'primary.main' }}>
                    {t('home.alm_rbi_bucket_analysis')} ({t('home.as_on')} {selectedDate})
                </Typography>
                ...
                {/* Deposit vs Loan Trend with CD Ratio */}
                <Typography variant="h6" sx={{ mt: 4, mb: 2, fontWeight: 600, color: 'primary.main' }}>
                    {t('home.credit_deposit_ratio_analysis')}
                </Typography>
                ...
                {/* RBI Loan Audit Table */}
                <Typography variant="h6" sx={{ mt: 4, mb: 2, fontWeight: 600, color: 'primary.main', display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
                    <AssignmentIcon /> {t('home.rbi_loan_audit_report')}
                    <Chip label={t('home.as_per_rbi_guidelines')} size="small" color="primary" />
                </Typography>
                ...
                {selectedDate === 'all' ? (
                    ...
                    <Paper sx={{ p: 2, mb: 4, borderRadius: 3 }}>
                        <Grid container spacing={2} sx={{ mb: 2 }}>
                            ...
                            <Grid size={{ xs: 6, sm: 3, md: 2 }}>
                                <StyledCard
                                    title={t('home.total_outstanding')}
                                    value={formatCurrency(rbiAuditData.reduce((sum, item) => sum + (item.outstandinG_AMOUNT || 0), 0))}
                                    icon={<AttachMoney />}
                                    colorIndex={2}
                                />
                            ...
                            <Grid size={{ xs: 6, sm: 3, md: 2 }}>
                                <StyledCard
                                    title={t('home.provision_coverage')}
                                    value={formatPercentage(
                                        rbiAuditData.reduce((sum, item) => sum + (item.outstandinG_AMOUNT || 0), 0) > 0
                                            ? (rbiAuditData.reduce((sum, item) => sum + (item.totaL_PROVISION || 0), 0) /
                                                rbiAuditData.reduce((sum, item) => sum + (item.outstandinG_AMOUNT || 0), 0)) * 100
                        ...
                        <Box sx={{ display: 'flex', gap: 2, mb: 2, flexWrap: 'wrap' }}>
                                <TextField
                                    size="small"
                                    placeholder={t('common.search_placeholder', 'Search by Account No, Name, Mobile...')}
                                    value={searchTerm}
                                    onChange={(e) => setSearchTerm(e.target.value)}
                                sx={{ minWidth: 250 }}
                                InputProps={{
                            ...
                            />
                            <FormControl size="small" sx={{ minWidth: 150 }}>
                                <InputLabel>{t('home.rbi_asset_class')}</InputLabel>
                                <Select
                                    value={rbiClassFilter}
                                    label={t('home.rbi_asset_class', 'RBI Asset Class')}
                                    onChange={(e) => setRbiClassFilter(e.target.value)}
                                >
                                    <MenuItem value="">{t('common.all', 'All')}</MenuItem>
                                    <MenuItem value="STANDARD">{t('common.standard', 'Standard')}</MenuItem>
                                    <MenuItem value="SMA-0">SMA-0</MenuItem>
                                    <MenuItem value="SMA-1">SMA-1</MenuItem>
                                    <MenuItem value="SMA-2">SMA-2</MenuItem>
                                    <MenuItem value="NPA">NPA</MenuItem>
                            ...
                            <FormControl size="small" sx={{ minWidth: 150 }}>
                                <InputLabel>{t('home.security_type')}</InputLabel>
                                <Select
                                    value={securityTypeFilter}
                                    label={t('home.security_type', 'Security Type')}
                                    onChange={(e) => setSecurityTypeFilter(e.target.value)}
                                >
                                    <MenuItem value="">{t('common.all', 'All')}</MenuItem>
                                    <MenuItem value="SECURED">{t('common.secured', 'Secured')}</MenuItem>
                                    <MenuItem value="UNSECURED">{t('common.unsecured', 'Unsecured')}</MenuItem>
                                </Select>
                            </FormControl>
                            <Button
                                size="small"
                        ...
                        <TableContainer sx={{ maxHeight: 500 }}>
                            <Table stickyHeader size="small">
                                <TableHead>
                                    <TableRow sx={{ bgcolor: 'primary.main' }}>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.loan_account_no')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.borrower_name')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.branch')}</TableCell>
                                        <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.outstanding')}</TableCell>
                                        <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.overdue')}</TableCell>
                                        <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.days_past_due')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.rbi_asset_class')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.security_type')}</TableCell>
                                        <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.provision')}</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {paginatedAuditData.length === 0 ? (
                                        <TableRow>
                                            <TableCell colSpan={9} align="center" sx={{ py: 3 }}>
                                                <Typography color="textSecondary">{t('common.no_records')}</Typography>
                                            </TableCell>
                                        </TableRow>
                                    ) : (
                                        paginatedAuditData.map((row, index) => (
                                            <TableRow key={index} hover sx={{
                                                ...
                                                <TableCell align="right">
                                                    <Chip
                                                        label={`${row.dayS_PAST_DUE} ${t('home.days')}`}
                                                        size="small"
                                                        color={row.dayS_PAST_DUE > 90 ? 'error' : row.dayS_PAST_DUE > 30 ? 'warning' : 'success'}
                                                        variant="outlined"
                                                    />
                ...
                {/* RBI Deposit Audit Table with Pagination */}
                <Typography variant="h6" sx={{ mt: 4, mb: 2, fontWeight: 600, color: 'primary.main', display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
                    <Savings /> {t('home.rbi_deposit_audit_report')}
                    <Chip label={t('home.as_per_rbi_guidelines')} size="small" color="primary" />
                    {totalDepositCount > 0 && (
                        <Chip
                            label={`${totalDepositCount.toLocaleString()} ${t('home.total_records')}`}
                            size="small"
                            variant="outlined"
                            color="info"
                        />
                ...
                {selectedDate === 'all' ? (
                    ...
                    <Paper sx={{ p: 2, mb: 4, borderRadius: 3 }}>
                        <Grid container spacing={2} sx={{ mb: 2 }}>
                            ...
                            <Grid size={{ xs: 6, sm: 3, md: 2 }}>
                                <StyledCard
                                    title={t('home.high_value_accounts')}
                                    value="N/A"
                                    icon={<TrendingUp />}
                                    colorIndex={4}
                                />
                            ...
                            <Grid size={{ xs: 6, sm: 3, md: 2 }}>
                                <StyledCard
                                    title={t('home.inoperative_accounts')}
                                    value="N/A"
                                    icon={<ErrorOutline />}
                                    colorIndex={5}
                                />
                        ...
                        <Box sx={{ display: 'flex', gap: 2, mb: 2, flexWrap: 'wrap' }}>
                            ...
                            <Typography variant="caption" sx={{ alignSelf: 'center', ml: 'auto', color: '#666' }}>
                                {t('common.showing')} {rbiDepositData.length} {t('common.of')} {totalDepositCount.toLocaleString()} {t('common.records')}
                            </Typography>
                        </Box>
                        ...
                        <TableContainer sx={{ maxHeight: 500 }}>
                            <Table stickyHeader size="small">
                                <TableHead>
                                    <TableRow sx={{ bgcolor: 'primary.main' }}>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.account_no')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.customer_name')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.branch')}</TableCell>
                                        <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.current_balance')}</TableCell>
                                        <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.deposit_amount')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.maturity_date')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.kyc_status')}</TableCell>
                                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'primary.main', color: 'white' }}>{t('rbi_audit.account_status')}</TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {rbiDepositData.length === 0 ? (
                                        ...
                                        rbiDepositData.map((row, index) => (
                                            <TableRow key={index} hover>
                                                ...
                                                <TableCell>
                                                    <Chip
                                                        label={row.kyC_STATUS || t('common.pending')}
                                                        size="small"
                                                        color={row.kyC_STATUS === 'FULL' ? 'success' : 'warning'}
                                                        variant="outlined"
                                                    />
                                                ...
                                                <TableCell>
                                                    <Chip
                                                        label={row.accounT_ACTIVITY_STATUS || t('common.active')}
                                                        size="small"
                                                        color={row.accounT_ACTIVITY_STATUS === 'INOPERATIVE' ? 'error' : 'success'}
                                                        variant="outlined"
                                                    />
                        ...
                        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mt: 2 }}>
                            <TablePagination
                                ...
                                rowsPerPage={depositRowsPerPage}
                                page={depositPage}
                                onPageChange={(e, newPage) => setDepositPage(newPage)}
                                onRowsPerPageChange={(e) => {
                                    setDepositRowsPerPage(parseInt(e.target.value, 10));
                                    setDepositPage(0);
                                }}
